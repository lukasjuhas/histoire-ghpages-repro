import { M as defineAsyncComponent, W as useDark, X as useToggle, Y as markRaw } from "./vendor.64dcab3f.js";
...
const Comp0 = defineAsyncComponent(() => __vitePreload(() => import("./Button.story.1fd628ea.js"), true ? ["assets/Button.story.1fd628ea.js","assets/vendor.64dcab3f.js"] : void 0));
const Comp1 = defineAsyncComponent(() => __vitePreload(() => import("./vendor.64dcab3f.js").then(function(n) {
  return n.av;
}), true ? [] : void 0));
let files = [
