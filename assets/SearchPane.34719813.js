import { _ as __vitePreload } from "./mapping.1a67fd8f.js";
import { Y as markRaw, d as defineComponent, r as ref, a2 as useFocus, w as watch, a3 as refDebounced, c as computed, a as openBlock, b as createElementBlock, e as createBaseVNode, l as createVNode, i as unref, I as Icon, L as withDirectives, a4 as vModelText, v as withKeys, g as withModifiers, j as createBlock, k as withCtx, F as Fragment, H as renderList, m as createCommentVNode, Q as createTextVNode, a5 as flexsearch, P as useCssVars, a6 as toRefs, a7 as useRouter, n as normalizeClass, t as toDisplayString } from "./vendor.f63f5b0c.js";
import { u as useStoryStore, _ as _export_sfc, a as useScrollOnActive, o as onKeyboardShortcut, B as BaseListItemLink } from "./bundle-main.4331d842.js";
import { B as BaseEmpty } from "./BaseEmpty.ab856aa6.js";
let searchData$1 = { "index": { "reg": '{"0":1,"1":1,"2":1,"3":1}', "text.cfg": '{"doc":0,"opt":1}', "text.map": '[{"p":[0,1,2,3],"po":[0,1,2,3],"pot":[0,1,2,3],"poto":[0,1,2,3],"potom":[0,1,2,3]},{"t":[1],"te":[1],"tef":[1],"tefa":[1],"tefao":[1],"tefaol":[1],"tefaolt":[1],"s":[2],"sm":[2],"sma":[2],"smal":[2],"l":[3],"la":[3],"lar":[3],"lark":[3],"larke":[3]},{},{},{},{},{},{},{}]', "text.ctx": "[{}]" }, "idMap": { "0": { "id": "src-components-button-story-vue", "kind": "story" }, "1": { "id": "src-components-button-story-vue:src-components-button-story-vue-0", "kind": "variant" }, "2": { "id": "src-components-button-story-vue:src-components-button-story-vue-1", "kind": "variant" }, "3": { "id": "src-components-button-story-vue:src-components-button-story-vue-2", "kind": "variant" } } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data.36e9e1b6.js"), true ? ["assets/search-docs-data.36e9e1b6.js","assets/vendor.f63f5b0c.js"] : void 0);
    function close() {
      emit("close");
    }
    const input = ref();
