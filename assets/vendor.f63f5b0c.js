var style = /* @__PURE__ */ (() => `@import url('https://fonts.googleapis.com/css2?family=Lato&display=swap');
...
const toDisplayString = (val) => {
  return isString$2(val) ? val : val == null ? "" : isArray(val) || isObject(val) && (val.toString === objectToString || !isFunction(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
function createSetupStore($id, setup2, options = {}, pinia, hot, isOptionsStore) {
  ...
  const store = reactive(assign$2(IS_CLIENT ? {
...
function getRectRelativeToOffsetParent$1(element, offsetParent, strategy) {
  ...
  const rect = getBoundingClientRect$1(element, isOffsetParentAnElement && isScaled$1(offsetParent));
  let scroll = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function getScrollParents$1(node, list) {
  ...
  return isBody ? updatedList : updatedList.concat(getScrollParents$1(getParentNode$1(target)));
}
...
const computePosition$2 = (reference, floating, options) => computePosition$3(reference, floating, {
  platform: platform$1,
  ...options
});
...
function getAllParentThemes$1(theme) {
  const result = [theme];
  let themeConfig = config$3.themes[theme] || {};
  do {
    if (themeConfig.$extend) {
...
const shownPoppersByTheme$1 = {};
function getShownPoppersByTheme$1(theme) {
  let list = shownPoppersByTheme$1[theme];
  if (!list) {
    list = shownPoppersByTheme$1[theme] = [];
  }
  return list;
}
...
function defaultPropFactory$1(prop) {
  return function(props) {
    return getDefaultConfig$1(props.theme, prop);
  };
}
const PROVIDE_KEY$1 = "__floating-vue__popper";
var PrivatePopper$1 = () => defineComponent({
  ...
  props: {
    ...
    positioningDisabled: {
      type: Boolean,
      default: defaultPropFactory$1("positioningDisabled")
    },
    placement: {
      type: String,
    ...
    autoSize: {
      type: [Boolean, String],
      default: defaultPropFactory$1("autoSize")
    },
    autoMaxSize: {
      type: Boolean,
    ...
    autoBoundaryMaxSize: {
      type: Boolean,
      default: defaultPropFactory$1("autoBoundaryMaxSize")
    },
    preventOverflow: {
      type: Boolean,
  ...
  computed: {
    ...
    slotData() {
      return {
        ...
        classes: __spreadProps$2(__spreadValues$2({}, this.classes), {
    ...
    parentPopper() {
      var _a2;
      return (_a2 = this[PROVIDE_KEY$1]) == null ? void 0 : _a2.parentPopper;
    },
  ...
  methods: {
    ...
    $_scheduleShow(event = null, skipDelay = false) {
      ...
      if (hidingPopper$1 && this.instantMove && hidingPopper$1.instantMove && hidingPopper$1 !== this.parentPopper) {
    ...
    async $_applyShowEffect() {
      ...
      if (showGroup) {
        let popover;
        for (let i = 0; i < shownPoppers$1.length; i++) {
          popover = shownPoppers$1[i];
      ...
      for (const theme of getAllParentThemes$1(this.theme)) {
        getShownPoppersByTheme$1(theme).push(this);
    ...
    async $_applyHide(skipTransition = false) {
      ...
      if (shownPoppers$1.length === 0) {
        document.body.classList.remove("v-popper--some-open");
      }
      for (const theme of getAllParentThemes$1(this.theme)) {
        const list = getShownPoppersByTheme$1(theme);
        removeFromArray$1(list, this);
        if (list.length === 0) {
    ...
    $_addEventListeners() {
      ...
      this.$_registerTriggerListeners(this.$_targetNodes, SHOW_EVENT_MAP$1, this.triggers, this.showTriggers, handleShow);
      this.$_registerTriggerListeners([this.$_popperNode], SHOW_EVENT_MAP$1, this.popperTriggers, this.popperShowTriggers, handleShow);
      ...
      this.$_registerTriggerListeners(this.$_targetNodes, HIDE_EVENT_MAP$1, this.triggers, this.hideTriggers, handleHide);
      this.$_registerTriggerListeners([this.$_popperNode], HIDE_EVENT_MAP$1, this.popperTriggers, this.popperHideTriggers, handleHide);
    },
    ...
    $_isAimingPopper() {
      ...
      if (mouseX$1 >= referenceBounds.left && mouseX$1 <= referenceBounds.right && mouseY$1 >= referenceBounds.top && mouseY$1 <= referenceBounds.bottom) {
        const popperBounds = this.$_popperNode.getBoundingClientRect();
        const vectorX = mouseX$1 - mousePreviousX$1;
        const vectorY = mouseY$1 - mousePreviousY$1;
        const distance = popperBounds.left + popperBounds.width / 2 - mousePreviousX$1 + (popperBounds.top + popperBounds.height / 2) - mousePreviousY$1;
        const newVectorLength = distance + popperBounds.width + popperBounds.height;
        const edgeX = mousePreviousX$1 + vectorX * newVectorLength;
        const edgeY = mousePreviousY$1 + vectorY * newVectorLength;
        return lineIntersectsLine$1(mousePreviousX$1, mousePreviousY$1, edgeX, edgeY, popperBounds.left, popperBounds.top, popperBounds.left, popperBounds.bottom) || lineIntersectsLine$1(mousePreviousX$1, mousePreviousY$1, edgeX, edgeY, popperBounds.left, popperBounds.top, popperBounds.right, popperBounds.top) || lineIntersectsLine$1(mousePreviousX$1, mousePreviousY$1, edgeX, edgeY, popperBounds.right, popperBounds.top, popperBounds.right, popperBounds.bottom) || lineIntersectsLine$1(mousePreviousX$1, mousePreviousY$1, edgeX, edgeY, popperBounds.left, popperBounds.bottom, popperBounds.right, popperBounds.bottom);
      }
      return false;
    }
  },
...
function handleGlobalClose$1(event, touch = false) {
  const preventClose = {};
  for (let i = shownPoppers$1.length - 1; i >= 0; i--) {
    const popper = shownPoppers$1[i];
    try {
      const contains2 = popper.$_containsGlobalTarget = isContainingEventTarget$1(popper, event);
      popper.$_pendingHide = false;
      requestAnimationFrame(() => {
        popper.$_pendingHide = false;
        if (preventClose[popper.randomId])
          return;
        if (shouldAutoHide$1(popper, contains2, event)) {
          ...
          while (parent) {
            if (shouldAutoHide$1(parent, parent.$_containsGlobalTarget, event)) {
...
function isContainingEventTarget$1(popper, event) {
  const popperContent = popper.popperNode();
  return popper.$_mouseDownContains || popperContent.contains(event.target);
}
function shouldAutoHide$1(popper, contains2, event) {
  return event.closeAllPopover || event.closePopover && contains2 || getAutoHideResult$1(popper, event) && !contains2;
}
function getAutoHideResult$1(popper, event) {
...
let mousePreviousX$1 = 0;
let mousePreviousY$1 = 0;
let mouseX$1 = 0;
let mouseY$1 = 0;
if (typeof window !== "undefined") {
  window.addEventListener("mousemove", (event) => {
    mousePreviousX$1 = mouseX$1;
    mousePreviousY$1 = mouseY$1;
    mouseX$1 = event.clientX;
    mouseY$1 = event.clientY;
  }, supportsPassive$1 ? {
    passive: true
  } : void 0);
}
function lineIntersectsLine$1(x1, y1, x2, y2, x3, y3, x4, y4) {
...
var PrivateThemeClass$1 = (prop = "theme") => ({
  computed: {
    themeClass() {
      return getThemeClasses$1(this[prop]);
    }
  }
});
...
const _sfc_main$4$2 = defineComponent({
  ...
  mixins: [
    ...
    PrivateThemeClass$1("finalTheme")
  ],
  props: {
    theme: {
      type: String,
...
const _sfc_main$2$2 = defineComponent(__spreadProps$2(__spreadValues$2({}, PrivatePopperWrapper$1), {
  name: "VMenu",
  vPopperTheme: "menu"
}));
const _sfc_main$1$2 = defineComponent(__spreadProps$2(__spreadValues$2({}, PrivatePopperWrapper$1), {
  name: "VTooltip",
...
function getOptions$2(el, value, modifiers) {
  let options2;
  ...
  directiveApp$1 = createApp({
    ...
    render() {
      return this.directives.map((directive) => {
        return h(PrivateTooltipDirective$1, __spreadProps$2(__spreadValues$2({}, directive.options), {
...
function createTooltip$1(el, value, modifiers) {
  ensureDirectiveApp$1();
  const options2 = ref(getOptions$2(el, value, modifiers));
  ...
  if (el.classList) {
    el.classList.add(TARGET_CLASS$1);
  }
...
function destroyTooltip$1(el) {
  ...
  if (el.classList) {
    el.classList.remove(TARGET_CLASS$1);
  }
}
function bind$1(el, { value, modifiers }) {
  const options2 = getOptions$2(el, value, modifiers);
  if (!options2.content || getDefaultConfig$1(options2.theme || "tooltip", "disabled")) {
    ...
    if (el.$_popper) {
      ...
      directive = createTooltip$1(el, value, modifiers);
    }
...
function compute(e2, i) {
  var o = window, l = i.scrollMode, d2 = i.block, u2 = i.inline, h2 = i.boundary, a2 = i.skipOverflowHiddenElements, c2 = typeof h2 == "function" ? h2 : function(t2) {
    return t2 !== h2;
  };
  if (!t(e2))
    throw new TypeError("Invalid target");
  for (var f = document.scrollingElement || document.documentElement, s = [], p2 = e2; t(p2) && c2(p2); ) {
    if ((p2 = p2.parentElement) === f) {
      s.push(p2);
      break;
    }
    p2 != null && p2 === document.body && n(p2) && !n(document.documentElement) || p2 != null && n(p2, a2) && s.push(p2);
  }
  for (var m = o.visualViewport ? o.visualViewport.width : innerWidth, g = o.visualViewport ? o.visualViewport.height : innerHeight, w = window.scrollX || pageXOffset, v2 = window.scrollY || pageYOffset, W2 = e2.getBoundingClientRect(), b2 = W2.height, H = W2.width, y = W2.top, E2 = W2.right, M2 = W2.bottom, V2 = W2.left, x2 = d2 === "start" || d2 === "nearest" ? y : d2 === "end" ? M2 : y + b2 / 2, I2 = u2 === "center" ? V2 + H / 2 : u2 === "end" ? E2 : V2, C2 = [], T2 = 0; T2 < s.length; T2++) {
    var k = s[T2], B = k.getBoundingClientRect(), D2 = B.height, O2 = B.width, R = B.top, X = B.right, Y2 = B.bottom, L2 = B.left;
    if (l === "if-needed" && y >= 0 && V2 >= 0 && M2 <= g && E2 <= m && y >= R && M2 <= Y2 && V2 >= L2 && E2 <= X)
      return C2;
    var S2 = getComputedStyle(k), j = parseInt(S2.borderLeftWidth, 10), q = parseInt(S2.borderTopWidth, 10), z = parseInt(S2.borderRightWidth, 10), A = parseInt(S2.borderBottomWidth, 10), F2 = 0, G2 = 0, J2 = "offsetWidth" in k ? k.offsetWidth - k.clientWidth - j - z : 0, K2 = "offsetHeight" in k ? k.offsetHeight - k.clientHeight - q - A : 0;
    if (f === k)
      F2 = d2 === "start" ? x2 : d2 === "end" ? x2 - g : d2 === "nearest" ? r(v2, v2 + g, g, q, A, v2 + x2, v2 + x2 + b2, b2) : x2 - g / 2, G2 = u2 === "start" ? I2 : u2 === "center" ? I2 - m / 2 : u2 === "end" ? I2 - m : r(w, w + m, m, j, z, w + I2, w + I2 + H, H), F2 = Math.max(0, F2 + v2), G2 = Math.max(0, G2 + w);
    else {
      F2 = d2 === "start" ? x2 - R - q : d2 === "end" ? x2 - Y2 + A + K2 : d2 === "nearest" ? r(R, Y2, D2, q, A + K2, x2, x2 + b2, b2) : x2 - (R + D2 / 2) + K2 / 2, G2 = u2 === "start" ? I2 - L2 - j : u2 === "center" ? I2 - (L2 + O2 / 2) + J2 / 2 : u2 === "end" ? I2 - X + z + J2 : r(L2, X, O2, j, z + J2, I2, I2 + H, H);
      var N2 = k.scrollLeft, P2 = k.scrollTop;
      x2 += P2 - (F2 = Math.max(0, Math.min(P2 + F2, k.scrollHeight - D2 + K2))), I2 += N2 - (G2 = Math.max(0, Math.min(N2 + G2, k.scrollWidth - O2 + J2)));
    }
    C2.push({ el: k, top: F2, left: G2 });
  }
  return C2;
}
...
function useMediaQuery(query, options = {}) {
  const { window: window2 = defaultWindow$1 } = options;
  const isSupported2 = Boolean(window2 && "matchMedia" in window2);
  let mediaQuery;
...
function useTitle(newTitle = null, options = {}) {
  ...
  watch(title, (t2, o) => {
    if (isString$1(t2) && t2 !== o && document2)
...
function getIconData$1$1(data, name, full = false) {
...
function parseIconSet$1(data, callback, options) {
  options = options || {};
  const names = [];
  ...
  Object.keys(icons).forEach((name) => {
    const iconData = getIconData$1$1(data, name, true);
    if (iconData) {
  ...
  if (parseAliases !== "none" && typeof data.aliases === "object") {
    ...
    Object.keys(aliases).forEach((name) => {
      if (parseAliases === "variations" && isVariation$1(aliases[name])) {
        return;
      }
      const iconData = getIconData$1$1(data, name, true);
      if (iconData) {
...
for (const prop in iconDefaults$1) {
  optionalProperties$1[prop] = typeof iconDefaults$1[prop];
}
function quicklyValidateIconSet$1(obj) {
  ...
  for (const prop in optionalProperties$1) {
    if (obj[prop] !== void 0 && typeof obj[prop] !== optionalProperties$1[prop]) {
      return null;
    }
  }
  const icons = data.icons;
  for (const name in icons) {
    ...
    for (const prop in iconDefaults$1) {
      if (icon[prop] !== void 0 && typeof icon[prop] !== typeof iconDefaults$1[prop]) {
        return null;
      }
    }
  }
  ...
  if (aliases) {
    for (const name in aliases) {
      ...
      if (!name.match(matchName$1) || typeof parent !== "string" || !icons[parent] && !aliases[parent]) {
        return null;
      }
      for (const prop in iconDefaults$1) {
        if (icon[prop] !== void 0 && typeof icon[prop] !== typeof iconDefaults$1[prop]) {
...
try {
  const w = window || self;
  if (w && w._iconifyStorage.version === storageVersion$1) {
    storage$1$1 = w._iconifyStorage.storage;
  }
} catch (err) {
}
...
function addCollection$1(data, provider) {
  ...
  if (simpleNames$1 && provider === "" && (typeof data.prefix !== "string" || data.prefix === "")) {
    let added = false;
    if (quicklyValidateIconSet$1(data)) {
      data.prefix = "";
  ...
  if (typeof data.prefix !== "string" || !validateIcon$1({
    provider,
    prefix: data.prefix,
    name: "a"
  })) {
  ...
  const storage2 = getStorage$1(provider, data.prefix);
...
const mergeParams$1 = (base, params) => {
...
const send$1 = (host, params, callback) => {
  ...
  switch (params.type) {
    case "icons": {
      ...
      path += mergeParams$1(prefix + ".json", {
        icons: iconsList
      });
      break;
    }
...
function initRedundancy$1(cfg) {
  ...
  function query(payload, queryCallback, doneCallback) {
    const query2 = sendQuery$1(config2, payload, queryCallback, (data, error) => {
      cleanup();
      if (doneCallback) {
...
function sendAPIQuery$1(target, query, callback) {
  ...
  if (typeof target === "string") {
    ...
    const config2 = createAPIConfig$1(target);
    if (config2) {
...
function loadNewIcons$1(provider, prefix, icons) {
  ...
  if (!providerQueueFlags[prefix]) {
    ...
    setTimeout(() => {
      ...
      params.forEach((item) => {
        sendAPIQuery$1(provider, item, (data, error) => {
          const storage2 = getStorage$1(provider, prefix);
          if (typeof data !== "object") {
            if (error !== 404) {
              return;
...
function destroyCache$1(storage2) {
  try {
    ...
    for (let i = 0; i < total; i++) {
      storage2.removeItem(cachePrefix$1 + i.toString());
    }
  } catch (err) {
  }
}
const loadCache$1 = () => {
  ...
  function load(key) {
    ...
    const getItem = (index) => {
      const name = cachePrefix$1 + index.toString();
      ...
      try {
        ...
        if (typeof data !== "object" || typeof data.cached !== "number" || data.cached < minTime || typeof data.provider !== "string" || typeof data.data !== "object" || typeof data.data.prefix !== "string") {
          ...
          const storage2 = getStorage$1(provider, prefix);
          valid = addIconSet$1(storage2, data.data).length > 0;
        }
      } catch (err) {
        valid = false;
      }
...
const storeCache$1 = (provider, data) => {
  if (!loaded$1) {
    loadCache$1();
  }
  function store(key) {
    ...
    let index = emptyList$1[key].shift();
    if (index === void 0) {
      index = count$1[key];
      if (!setCount$1(func, key, index + 1)) {
        return false;
      }
    }
    try {
      ...
      func.setItem(cachePrefix$1 + index.toString(), JSON.stringify(item));
    } catch (err) {
      return false;
    }
    return true;
...
const render$2 = (icon, props) => {
  const customisations = mergeCustomisations$1(defaults$1, props);
...
const Icon$1 = defineComponent({
  ...
  methods: {
    ...
    getIcon(icon, onload) {
      ...
      const data = getIconData$2(iconName);
      if (data === null) {
  ...
  const proxy = new Proxy(target, {
    get(_, p2) {
      ...
      if (specialKeysHandler) {
        const fn = specialKeysHandler(target, p2);
        if (fn) {
          return fn();
        }
      }
...
function applyStateToVariant(variant, state) {
  if (variant.state) {
...
const computePosition$1 = async (reference, floating, config2) => {
  ...
  let {
    x: x2,
    y
  } = computeCoordsFromPlacement(__spreadProps(__spreadValues$1({}, rects), {
    placement
  }));
  let statefulPlacement = placement;
  let middlewareData = {};
...
async function detectOverflow(middlewareArguments, options) {
  ...
  const elementClientRect = rectToClientRect(await platform2.convertOffsetParentRelativeRectToViewportRelativeRect({
    rect: elementContext === "floating" ? __spreadProps(__spreadValues$1({}, rects.floating), {
      x: x2,
      y
    }) : rects.reference,
    offsetParent: await platform2.getOffsetParent({
...
function convertValueToCoords(_ref) {
  ...
  const basePlacement = getBasePlacement(placement);
  const multiplier = ["left", "top"].includes(basePlacement) ? -1 : 1;
  const rawValue = typeof value === "function" ? value(__spreadProps(__spreadValues$1({}, rects), {
    placement
  })) : value;
  const {
    mainAxis,
...
const shift = function(options) {
  ...
  return {
    ...
    async fn(middlewareArguments) {
      ...
      const limitedCoords = limiter.fn(__spreadProps(__spreadValues$1({}, middlewareArguments), {
        [mainAxis]: mainAxisCoord,
        [crossAxis]: crossAxisCoord
      }));
      return __spreadProps(__spreadValues$1({}, limitedCoords), {
        data: {
          x: limitedCoords.x - x2,
          y: limitedCoords.y - y
        }
...
const size = function(options) {
  ...
  return {
    ...
    async fn(middlewareArguments) {
      ...
      apply == null ? void 0 : apply(__spreadValues$1(__spreadValues$1({}, dimensions), rects));
      return {
        data: {
          skip: true
        },
...
const platform = {
  getElementRects: (_ref) => {
    ...
    return {
      ...
      floating: __spreadProps(__spreadValues$1({}, getDimensions(floating)), {
        x: 0,
        y: 0
      })
    };
...
const computePosition = (reference, floating, options) => computePosition$1(reference, floating, __spreadValues$1({
  platform
}, options));
...
const _sfc_main$b = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$b), {
  props: {
    title: null
  },
  setup(__props) {
...
const _sfc_main$a = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$a), {
  props: {
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$9), {
  props: {
    title: null,
    modelValue: null
  },
      ...
      return openBlock(), createBlock(_sfc_main$b, {
        ...
        default: withCtx(() => [
          createBaseVNode("input", mergeProps({
            ref_key: "input",
            ref: input
          }, __spreadProps(__spreadValues$1({}, _ctx.$attrs), { class: null, style: null }), {
            type: "text",
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$8), {
  props: {
    title: null,
    modelValue: null
  },
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$7), {
  props: {
    title: null,
    modelValue: null,
    min: null,
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$6), {
  props: {
    title: null,
    modelValue: null
  },
...
function fullIcon(data) {
  return __spreadValues$1(__spreadValues$1({}, iconDefaults), data);
}
...
function mergeIconData(icon, alias) {
  const result = __spreadValues$1({}, icon);
...
const render = (icon, props) => {
  ...
  const componentProps = __spreadValues$1({}, svgDefaults);
  let style2 = typeof props.style === "object" && !(props.style instanceof Array) ? __spreadValues$1({}, props.style) : {};
  for (let key in props) {
    const value = props[key];
    if (value === void 0) {
      continue;
...
const Icon = defineComponent({
  ...
  render() {
    ...
    let newProps = props;
    if (icon.classes) {
      newProps = __spreadProps(__spreadValues$1({}, props), {
        class: (typeof props["class"] === "string" ? props["class"] + " " : "") + icon.classes.join(" ")
      });
    }
...
const _sfc_main$5 = defineComponent(__spreadProps(__spreadValues$1({}, __default__$5), {
  props: {
    modelValue: null,
    options: null
  },
        ...
        popper: withCtx(({ hide }) => [
          createBaseVNode("div", _hoisted_3$3, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(formattedOptions), (label, value) => {
              return openBlock(), createElementBlock("div", mergeProps(__spreadProps(__spreadValues$1({}, _ctx.$attrs), { class: null, style: null }), {
                key: label,
...
const _sfc_main$3$2 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$3), {
  props: {
    content: null
  },
  setup(__props) {
...
const _sfc_main$2$1 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$2), {
  props: {
    shades: null,
    getName: null,
    search: null
          ...
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", null, [
              createBaseVNode("div", _hoisted_3$2, [
                ...
                hover.value === shade.key ? (openBlock(), createBlock(_sfc_main$3$2, {
                  key: 0,
                  content: shade.name,
                  class: "htw-flex-none"
...
const _sfc_main$1$1 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__$1), {
  props: {
    tokens: null,
    getName: null
  },
        ...
        return openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_2$1, [
            createBaseVNode("div", _hoisted_3$1, [
              ...
              hover.value === token.key ? (openBlock(), createBlock(_sfc_main$3$2, {
                key: 0,
                content: token.name,
                class: "htw-flex-none"
              }, null, 8, ["content"])) : createCommentVNode("", true)
...
const _sfc_main$d = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues$1({}, __default__), {
  props: {
    tokens: null,
    colSize: { default: 180 },
...
const HstCopyIcon = _sfc_main$3$2;
...
(function(module2) {
  (function() {
    var unicodes = function(s, prefix) {
      ...
      title: function(s) {
        return Case2.capital(s).replace(re.improper, function(small, p2, i, s2) {
...
async function generateSourceCode(variant) {
  ...
  const lines = [];
  for (const n2 in list) {
    const vnode2 = list[n2];
...
async function printVNode(vnode, propsOverrides = null) {
  ...
  if (typeof vnode.type === "object" || typeof vnode.type === "string") {
    let genDirective = function(dirName, dir, valueCode = null) {
      ...
      var _a22, _b2, _c2;
      if (typeof value !== "string" || ((_a22 = vnode.dynamicProps) == null ? void 0 : _a22.includes(prop))) {
        let directive = ":";
    ...
    if (vnode.dirs) {
      for (const dir of vnode.dirs) {
        if (dir.dir === vModelText || dir.dir === vModelSelect || dir.dir === vModelRadio || dir.dir === vModelCheckbox || dir.dir === vModelDynamic) {
          ...
          let dirName;
          for (const directives2 of [target.directives, target.appContext.directives]) {
    ...
    if (vnode.children && typeof vnode.children === "object" && !Array.isArray(vnode.children)) {
      for (const key in vnode.children) {
        if (typeof vnode.children[key] === "function") {
          const autoObject = createAutoBuildingObject((key2) => `{{ ${key2} }}`, (target, p2) => {
            if (p2 === "__v_isRef") {
              return () => false;
            }
          });
...
const _sfc_main$2 = defineComponent({
  ...
  setup() {
    ...
    provide("implicitState", () => __spreadValues({}, implicitState));
  ...
  render() {
    ...
    if (firstVariant.id === "_default") {
      return h(_sfc_main$3, __spreadValues({
          ...
          if (props.slotName === "default") {
            const propsTypes = vnodes.filter((vnode) => typeof vnode.type === "object").map((vnode, index) => {
              ...
              for (const key in vnode.type.props) {
                ...
                if ((_c2 = (_b2 = (_a22 = props.variant.state) == null ? void 0 : _a22._hPropState) == null ? void 0 : _b2[index]) == null ? void 0 : _c2[key]) {
                  if (!vnode.props) {
                    vnode.props = {};
                  }
...
(function(module2, exports) {
  !function(t2, n2) {
    ...
    return t2 = { 770: function(t3, n3, e2) {
      ...
      class f {
        constructor(t4) {
          const n4 = t4.length, e3 = f._utf8ByteLength(t4), r3 = e3 !== n4, i2 = r3 ? new Uint32Array(n4 + 1) : null;
          r3 && (i2[n4] = e3);
          ...
          for (let e4 = 0; e4 < n4; e4++) {
            const f2 = t4.charCodeAt(e4);
            let u3 = f2, c3 = false;
            if (f2 >= 55296 && f2 <= 56319 && e4 + 1 < n4) {
              const n5 = t4.charCodeAt(e4 + 1);
              n5 >= 56320 && n5 <= 57343 && (u3 = 65536 + (f2 - 55296 << 10) | n5 - 56320, c3 = true);
            }
      ...
      class u2 {
        constructor(t4) {
          ...
          for (let e4 = 0, r4 = t4.length; e4 < r4; e4++)
            o._ofree(n4[e4]);
          o._ofree(i2), o._ofree(r3), a3 === 0 && function(t5) {
        ...
        findNextMatchSync(t4, n4, e3) {
          let r3 = a2, i2 = 0;
          if (typeof e3 == "number" ? (8 & e3 && (r3 = true), i2 = e3) : typeof e3 == "boolean" && (r3 = e3), typeof t4 == "string") {
            t4 = new s(t4);
        ...
        _findNextMatchSync(t4, n4, e3, r3) {
          ...
          let o2;
          if (o2 = e3 ? i2._findNextOnigScannerMatchDbg(this._ptr, t4.id, t4.ptr, t4.utf8Length, t4.convertUtf16OffsetToUtf8(n4), r3) : i2._findNextOnigScannerMatch(this._ptr, t4.id, t4.ptr, t4.utf8Length, t4.convertUtf16OffsetToUtf8(n4), r3), o2 === 0)
            return null;
          const a3 = i2.HEAPU32;
          let f2 = o2 / 4;
          const s2 = a3[f2++], u3 = a3[f2++];
          let c3 = [];
          for (let n5 = 0; n5 < u3; n5++) {
            const e4 = t4.convertUtf8OffsetToUtf16(a3[f2++]), r4 = t4.convertUtf8OffsetToUtf16(a3[f2++]);
      ...
      var n3 = (typeof document != "undefined" && document.currentScript && document.currentScript.src, function(t4) {
        ...
        var w, S2, A, b2 = typeof TextDecoder != "undefined" ? new TextDecoder("utf8") : void 0;
        ...
        function P2(t5) {
          w = t5, r2.HEAP8 = new Int8Array(t5), r2.HEAP16 = new Int16Array(t5), r2.HEAP32 = A = new Int32Array(t5), r2.HEAPU8 = S2 = new Uint8Array(t5), r2.HEAPU16 = new Uint16Array(t5), r2.HEAPU32 = new Uint32Array(t5), r2.HEAPF32 = new Float32Array(t5), r2.HEAPF64 = new Float64Array(t5);
        }
        ...
        var B = 0, j = null;
        function F2(t5) {
          B++, r2.monitorRunDependencies && r2.monitorRunDependencies(B);
        }
        function V2(t5) {
          if (B--, r2.monitorRunDependencies && r2.monitorRunDependencies(B), B == 0 && j) {
            var n5 = j;
            j = null, n5();
          }
        }
        function z(t5) {
          r2.onAbort && r2.onAbort(t5), d2(t5 += ""), y = true, t5 = "abort(" + t5 + "). Build with -s ASSERTIONS=1 for more info.";
        ...
        function X() {
          return g || !u2 || typeof fetch != "function" ? Promise.resolve().then(function() {
            return Q2(K2);
        ...
        function Z2() {
          ...
          return (g || typeof WebAssembly.instantiateStreaming != "function" || G2(K2) || typeof fetch != "function" ? o2(i2) : fetch(K2, { credentials: "same-origin" }).then(function(n6) {
        ...
        function et(t5) {
          try {
            return _.grow(t5 - w.byteLength + 65535 >>> 16), P2(_.buffer), 1;
          } catch (t6) {
          }
        }
        function rt(t5) {
        ...
        }, r2.UTF8ToString = U2, j = function t5() {
          ft || ct(), ft || (j = t5);
...
(function(module2, exports) {
  !function(e2, t2) {
    ...
    return function(e2) {
      ...
      var r2 = n2(1), i = n2(5), o = n2(6), s = n2(2), a2 = typeof performance == "undefined" ? function() {
        return Date.now();
      } : function() {
        return performance.now();
      };
          ...
          if (!e3.visitedRule.has(l2)) {
            ...
            if (g2)
              if (g2 === "$base" || g2 === t3.scopeName)
                f(e3, t3, t3);
              else if (g2 === "$self" || g2 === n3.scopeName)
                f(e3, t3, n3);
              else if (g2.charAt(0) === "#")
                ...
                if (m2 >= 0) {
                  ...
                  _2 === t3.scopeName ? p2(e3, t3, t3, y2, d3) : _2 === n3.scopeName ? p2(e3, t3, n3, y2, d3) : e3.add(new u2(_2, g2.substring(m2 + 1)));
                } else
                  e3.add(new c2(g2));
              }
          }
      ...
      function p2(e3, t3, n3, r3, i2) {
        (i2 === void 0 && (i2 = n3.repository), i2 && i2[r3]) && h2(e3, t3, n3, [i2[r3]], i2);
      }
      function f(e3, t3, n3) {
      ...
      t2.ScopeDependencyCollector = l, t2.collectSpecificDependencies = p2, t2.collectDependencies = f;
      ...
      var y = function() {
        ...
        function e3(e4, t3, n3, r3, i2, s2) {
          if (this._scopeMetadataProvider = new y(t3, i2, n3), this._onigLib = s2, this._rootId = -1, this._lastRuleId = 0, this._ruleId2desc = [null], this._includedGrammars = {}, this._grammarRepository = i2, this._grammar = C2(e4, null), this._injections = null, this._tokenTypeMatchers = [], r3)
        ...
        return e3.prototype.dispose = function() {
          ...
          if (this._injections === null) {
            ...
            if (t3)
              for (var n3 in t3)
                m(this._injections, n3, t3[n3], this, this._grammar);
            if (this._grammarRepository) {
              ...
              r3 && r3.forEach(function(t4) {
                ...
                if (n4) {
                  ...
                  r4 && m(e4._injections, r4, n4, e4, n4);
                }
              });
            }
          ...
          var r3;
          if (this._rootId === -1 && (this._rootId = i.RuleFactory.getCompiledRuleId(this._grammar.repository.$self, this, this._grammar.repository)), t3 && t3 !== I2.NULL)
            r3 = false, t3.reset();
          else {
            r3 = true;
            var o2 = this._scopeMetadataProvider.getDefaultMetadata(), s2 = o2.themeData[0], a3 = P2.set(0, o2.languageId, o2.tokenType, s2.fontStyle, s2.foreground, s2.background), c3 = this.getRule(this._rootId).getName(null, null), u3 = this._scopeMetadataProvider.getMetadataForScope(c3), l2 = x2.mergeMetadata(a3, null, u3), h3 = new x2(null, c3 === null ? "unknown" : c3, l2);
            t3 = new I2(null, this._rootId, -1, -1, false, null, h3, h3);
          }
          e4 += "\n";
          var p3 = this.createOnigString(e4), f2 = p3.content.length, d3 = new T2(n3, e4, this._tokenTypeMatchers), g2 = S2(this, p3, r3, 0, t3, d3, true);
          return b2(p3), { lineLength: f2, lineTokens: d3, ruleStack: g2 };
        }, e3;
      }();
      function b2(e3) {
      ...
      function w(e3, t3, n3, r3, i2, o2, s2) {
        if (o2.length !== 0) {
          for (var a3 = t3.content, c3 = Math.min(o2.length, s2.length), u3 = [], l2 = s2[0].end, h3 = 0; h3 < c3; h3++) {
            ...
            if (p3 !== null) {
              ...
              if (f2.length !== 0) {
                ...
                if (u3.length > 0 ? i2.produceFromScopes(u3[u3.length - 1].scopes, f2.start) : i2.produce(r3, f2.start), p3.retokenizeCapturedWithRuleId) {
                  var d3 = p3.getName(a3, s2), g2 = r3.contentNameScopesList.push(e3, d3), m2 = p3.getContentName(a3, s2), _2 = g2.push(e3, m2), y2 = r3.push(p3.retokenizeCapturedWithRuleId, f2.start, -1, false, null, g2, _2), v3 = e3.createOnigString(a3.substring(0, f2.end));
                  S2(e3, v3, n3 && f2.start === 0, f2.start, y2, i2, false), b2(v3);
                } else {
                  var C3 = p3.getName(a3, s2);
                  if (C3 !== null) {
                    var w2 = (u3.length > 0 ? u3[u3.length - 1].scopes : r3.contentNameScopesList).push(e3, C3);
      ...
      function R(e3, t3, n3, r3, i2, o2) {
        ...
        var l2 = function(e4, t4, n4, r4, i3, o3, a3) {
          for (var c4, u4 = Number.MAX_VALUE, l3 = null, h4 = 0, p4 = o3.contentNameScopesList.generateScopes(), f2 = 0, d3 = e4.length; f2 < d3; f2++) {
            var g2 = e4[f2];
            if (g2.matcher(p4)) {
              var m2 = t4.getRule(g2.ruleId).compile(t4, null, r4, i3 === a3), _2 = m2.scanner.findNextMatchSync(n4, i3);
              if (s.DebugFlags.InDebugMode && (console.log("  scanning for injections"), console.log(k(m2))), _2) {
                var y2 = _2.captureIndices[0].start;
                if (!(y2 >= u4) && (u4 = y2, l3 = _2.captureIndices, c4 = m2.rules[_2.index], h4 = g2.priority, u4 === i3))
                  break;
              }
            }
          }
          return l3 ? { priorityMatch: h4 === -1, captureIndices: l3, matchedRuleId: c4 } : null;
      ...
      function S2(e3, t3, n3, r3, o2, a3, c3) {
        ...
        if (c3) {
          var p3 = function(e4, t4, n4, r4, o3, a4) {
            ...
            for (var p4 = u4.pop(); p4; p4 = u4.pop()) {
              var f3 = p4.rule.compileWhile(e4, p4.stack.endRule, n4, c4 === r4), d3 = f3.scanner.findNextMatchSync(t4, r4);
              if (s.DebugFlags.InDebugMode && (console.log("  scanning for while rule"), console.log(k(f3))), !d3) {
                s.DebugFlags.InDebugMode && console.log("  popping " + p4.rule.debugName + " - " + p4.rule.debugWhileRegExp), o3 = p4.stack.pop();
                break;
              }
              if (f3.rules[d3.index] !== -2) {
                o3 = p4.stack.pop();
                break;
              }
              d3.captureIndices && d3.captureIndices.length && (a4.produce(p4.stack, d3.captureIndices[0].start), w(e4, t4, n4, p4.stack, a4, p4.rule.whileCaptures, d3.captureIndices), a4.produce(p4.stack, d3.captureIndices[0].end), c4 = d3.captureIndices[0].end, d3.captureIndices[0].end > r4 && (r4 = d3.captureIndices[0].end, n4 = false));
            }
        ...
        function f2() {
          ...
          var c4 = R(e3, t3, n3, r3, o2, h3);
          if (!c4)
            return s.DebugFlags.InDebugMode && console.log("  no more matches."), a3.produce(o2, u3), void (l2 = true);
          var p4 = c4.captureIndices, f3 = c4.matchedRuleId, d3 = !!(p4 && p4.length > 0) && p4[0].end > r3;
          if (f3 === -1) {
            var g2 = o2.getRule(e3);
            s.DebugFlags.InDebugMode && console.log("  popping " + g2.debugName + " - " + g2.debugEndRegExp), a3.produce(o2, p4[0].start), o2 = o2.setContentNameScopesList(o2.nameScopesList), w(e3, t3, n3, o2, a3, g2.endCaptures, p4), a3.produce(o2, p4[0].end);
            var m2 = o2;
            if (o2 = o2.pop(), h3 = m2.getAnchorPos(), !d3 && m2.getEnterPos() === r3)
              return s.DebugFlags.InDebugMode && console.error("[1] - Grammar is in an endless loop - Grammar pushed & popped a rule without advancing"), o2 = m2, a3.produce(o2, u3), void (l2 = true);
          } else {
            var _2 = e3.getRule(f3);
            a3.produce(o2, p4[0].start);
            var y2 = o2, v3 = _2.getName(t3.content, p4), b3 = o2.contentNameScopesList.push(e3, v3);
            if (o2 = o2.push(f3, r3, h3, p4[0].end === u3, null, b3, b3), _2 instanceof i.BeginEndRule) {
              var C3 = _2;
              s.DebugFlags.InDebugMode && console.log("  pushing " + C3.debugName + " - " + C3.debugBeginRegExp), w(e3, t3, n3, o2, a3, C3.beginCaptures, p4), a3.produce(o2, p4[0].end), h3 = p4[0].end;
              var k2 = C3.getContentName(t3.content, p4), S3 = b3.push(e3, k2);
              if (o2 = o2.setContentNameScopesList(S3), C3.endHasBackReferences && (o2 = o2.setEndRule(C3.getEndWithResolvedBackReferences(t3.content, p4))), !d3 && y2.hasSameRuleAs(o2))
              ...
              C3 = _2;
              s.DebugFlags.InDebugMode && console.log("  pushing " + C3.debugName), w(e3, t3, n3, o2, a3, C3.beginCaptures, p4), a3.produce(o2, p4[0].end), h3 = p4[0].end;
              k2 = C3.getContentName(t3.content, p4), S3 = b3.push(e3, k2);
              if (o2 = o2.setContentNameScopesList(S3), C3.whileHasBackReferences && (o2 = o2.setEndRule(C3.getWhileWithResolvedBackReferences(t3.content, p4))), !d3 && y2.hasSameRuleAs(o2))
              ...
              var P3 = _2;
              if (s.DebugFlags.InDebugMode && console.log("  matched " + P3.debugName + " - " + P3.debugMatchRegExp), w(e3, t3, n3, o2, a3, P3.captures, p4), a3.produce(o2, p4[0].end), o2 = o2.pop(), !d3)
      ...
      var P2 = function() {
        ...
        return e3.toBinaryStr = function(e4) {
          ...
          return n3 !== 0 && (a3 = n3), r3 !== 0 && (c3 = r3 === 8 ? 0 : r3), i2 !== -1 && (u3 = i2), o2 !== 0 && (l2 = o2), s2 !== 0 && (h3 = s2), (a3 << 0 | c3 << 8 | u3 << 11 | l2 << 14 | h3 << 23) >>> 0;
        }, e3;
      }();
      ...
      var r2 = this && this.__awaiter || function(e3, t3, n3, r3) {
        ...
        return o2 = { next: a3(0), throw: a3(1), return: a3(2) }, typeof Symbol == "function" && (o2[Symbol.iterator] = function() {
          return this;
        }), o2;
        function a3(o3) {
          return function(a4) {
      ...
      var o = n2(4), s = n2(8), a2 = n2(11), c2 = n2(0), u2 = function() {
        ...
        return e3.prototype.dispose = function() {
          ...
          return r2(this, void 0, void 0, function() {
            var r3, s2, a3, u3, l, h2, p2, f, d2, g, m, _, y = this;
            return i(this, function(i2) {
              switch (i2.label) {
                ...
                case 2:
                  ...
                  for (f = 0, d2 = l.full; f < d2.length; f++)
                    _ = d2[f], r3.has(_.scopeName) || (r3.add(_.scopeName), a3.push(_));
                  for (g = 0, m = l.partial; g < m.length; g++)
                    _ = m[g], r3.has(_.scopeName) || s2.has(_.toKey()) || (s2.add(_.toKey()), a3.push(_));
                  return [3, 1];
                case 3:
          ...
          return t3 === void 0 && (t3 = []), n3 === void 0 && (n3 = 0), o2 === void 0 && (o2 = null), r2(this, void 0, void 0, function() {
            return i(this, function(r3) {
              switch (r3.label) {
                case 0:
      ...
      var h2 = function() {
            ...
            if (e4) {
              for (var r3 = e4.length, i2 = 0, o2 = [], a3 = false, c3 = 0; c3 < r3; c3++) {
                if (e4.charAt(c3) === "\\" && c3 + 1 < r3) {
                  ...
                  u3 === "z" ? (o2.push(e4.substring(i2, c3)), o2.push("$(?!\\n)(?<!\\n)"), i2 = c3 + 2) : u3 !== "A" && u3 !== "G" || (a3 = true), c3++;
                }
              }
              this.hasAnchor = a3, i2 === 0 ? this.source = e4 : (o2.push(e4.substring(i2, r3)), this.source = o2.join(""));
            } else
        ...
        return e3.prototype.clone = function() {
          ...
          for (e4 = 0, t3 = this.source.length; e4 < t3; e4++)
            n3 = this.source.charAt(e4), i2[e4] = n3, o2[e4] = n3, s2[e4] = n3, a3[e4] = n3, n3 === "\\" && e4 + 1 < t3 && ((r3 = this.source.charAt(e4 + 1)) === "A" ? (i2[e4 + 1] = "\uFFFF", o2[e4 + 1] = "\uFFFF", s2[e4 + 1] = "A", a3[e4 + 1] = "A") : r3 === "G" ? (i2[e4 + 1] = "\uFFFF", o2[e4 + 1] = "G", s2[e4 + 1] = "\uFFFF", a3[e4 + 1] = "G") : (i2[e4 + 1] = r3, o2[e4 + 1] = r3, s2[e4 + 1] = r3, a3[e4 + 1] = r3), e4++);
            ...
            for (var o2 = 0, s2 = t3.length; o2 < s2; o2++) {
              ...
              if (a3.include)
                if (a3.include.charAt(0) === "#") {
                  ...
                  var f2 = n3.getExternalGrammar(l2, r3);
                  if (f2)
                    if (h3) {
                      var _2 = f2.repository[h3];
                      _2 && (c3 = e3.getCompiledRuleId(_2, n3, f2.repository));
                    } else
                      c3 = e3.getCompiledRuleId(f2.repository.$self, n3, f2.repository);
                }
              else
                c3 = e3.getCompiledRuleId(a3, n3, r3);
              if (c3 !== -1) {
                var y = n3.getRule(c3), v2 = false;
                if ((y instanceof d2 || y instanceof g || y instanceof m) && y.hasMissingPatterns && y.patterns.length === 0 && (v2 = true), v2)
                  continue;
                i2.push(c3);
              }
            }
      ...
      !function() {
        ...
        try {
          r2 = typeof clearTimeout == "function" ? clearTimeout : s;
        } catch (e3) {
          r2 = s;
        }
      }();
      ...
      function p2() {
        l && c2 && (l = false, c2.length ? u2 = c2.concat(u2) : h2 = -1, u2.length && f());
      }
      function f() {
        if (!l) {
          var e3 = a2(p2);
      ...
      i.nextTick = function(e3) {
        ...
        if (arguments.length > 1)
          for (var n3 = 1; n3 < arguments.length; n3++)
            t3[n3 - 1] = arguments[n3];
        u2.push(new d2(e3, t3)), u2.length !== 1 || l || a2(f);
      ...
      function r2(e3, t3, n3) {
        ...
        r3 > 0 && e3.charCodeAt(0) === 65279 && (i = 1);
        var f = 0, d2 = null, g = [], m = [], _ = null;
        function y(e4, t4) {
          g.push(f), m.push(d2), f = e4, d2 = t4;
        }
        function v2() {
          if (g.length === 0)
        ...
        function A() {
          return f === 1 || f !== 2 ? b2("unexpected </array>") : void v2();
        }
        function T2(e4) {
          if (f === 1) {
            if (_ === null)
        ...
        for (; i < r3 && (u2(), !(i >= r3)); ) {
          ...
          if (j !== 63)
            if (j !== 33) {
              ...
              var F2 = (w = void 0, k = void 0, w = p2(">"), k = false, w.charCodeAt(w.length - 1) === 47 && (k = true, w = w.substring(0, w.length - 1)), { name: w.trim(), isClosed: k });
              switch (F2.name) {
                case "dict":
                  f === 1 ? R() : f === 2 ? P2() : (d2 = {}, n3 !== null && (d2[n3] = { filename: t3, line: o, char: s }), y(1, d2)), F2.isClosed && I2();
                  continue;
                case "array":
                  f === 1 ? S2() : f === 2 ? x2() : y(2, d2 = []), F2.isClosed && A();
                  continue;
                case "key":
                  C2 = E2(F2), f !== 1 ? b2("unexpected <key>") : _ !== null ? b2("too many <key>") : _ = C2;
                  continue;
                case "string":
                  T2(E2(F2));
                  continue;
      ...
      Object.defineProperty(t2, "__esModule", { value: true }), t2.parse = function(e3, t3, n3) {
        ...
        for (; s(a2, c2); ) {
          if (u2 === 0) {
            if (l !== null && g("too many constructs in root"), c2.type === 3) {
              l = {}, n3 && (l.$vscodeTextmateLocation = c2.toLocation(t3)), f(), u2 = 1;
              continue;
            }
            if (c2.type === 2) {
              l = [], f(), u2 = 4;
          ...
          if (u2 === 1 || u2 === 3) {
            ...
            if (c2.type === 1) {
              var m = c2.value;
              if (s(a2, c2) && c2.type === 6 || g("expected colon"), s(a2, c2) || g("expected value"), u2 = 2, c2.type === 1) {
                l[m] = c2.value;
                continue;
              }
              if (c2.type === 8) {
              ...
              if (c2.type === 3) {
                var y = {};
                n3 && (y.$vscodeTextmateLocation = c2.toLocation(t3)), l[m] = y, f(), u2 = 1, l = y;
                continue;
              }
            }
          ...
          if (u2 === 4 || u2 === 6) {
            ...
            if (c2.type === 3) {
              y = {};
              n3 && (y.$vscodeTextmateLocation = c2.toLocation(t3)), l.push(y), f(), u2 = 1, l = y;
              continue;
            }
        ...
        return p2.length !== 0 && g("unclosed constructs"), l;
      };
      var i = function(e3) {
      ...
      function s(e3, t3) {
        ...
        if (t3.offset = o2, t3.line = a2, t3.char = c2, n3 === 34) {
          for (t3.type = 1, o2++, c2++; ; ) {
            if (o2 >= s2)
              return false;
        ...
        return t3.len = o2 - t3.offset, t3.value === null && (t3.value = i2.substr(t3.offset, t3.len)), e3.pos = o2, e3.line = a2, e3.char = c2, true;
      }
    }, function(e2, t2, n2) {
      Object.defineProperty(t2, "__esModule", { value: true });
      ...
      function o(e3) {
        ...
        for (var t3 = e3.settings, n3 = [], o2 = 0, s2 = 0, a3 = t3.length; s2 < a3; s2++) {
          ...
          if (c3.settings) {
            ...
            var f = null;
            typeof c3.settings.foreground == "string" && i(c3.settings.foreground) && (f = c3.settings.foreground);
            var d2 = null;
            ...
            for (h3 = 0, p3 = u3.length; h3 < p3; h3++) {
              ...
              g.length > 1 && (_ = g.slice(0, g.length - 1)).reverse(), n3[o2++] = new r2(m, _, s2, l2, f, d2);
            }
          }
        }
        return n3;
      ...
      function s(e3, t3) {
        e3.sort(function(e4, t4) {
          ...
          return n4 !== 0 || (n4 = l(e4.parentScopes, t4.parentScopes)) !== 0 ? n4 : e4.index - t4.index;
        });
        for (var n3 = 0, r3 = "#000000", i2 = "#ffffff"; e3.length >= 1 && e3[0].scope === ""; ) {
          var o2 = e3.shift();
          o2.fontStyle !== -1 && (n3 = o2.fontStyle), o2.foreground !== null && (r3 = o2.foreground), o2.background !== null && (i2 = o2.background);
        }
        for (var s2 = new a2(t3), f = new h2(0, null, n3, s2.getId(r3), s2.getId(i2)), d2 = new p2(new h2(0, null, -1, 0, 0), []), g = 0, m = e3.length; g < m; g++) {
          var _ = e3[g];
          d2.insert(0, _.scope, _.parentScopes, _.fontStyle, s2.getId(_.foreground), s2.getId(_.background));
        }
        return new c2(s2, f, d2);
      }
      ...
      var p2 = function() {
        ...
        return e3._sortBySpecificity = function(e4) {
          ...
          if (e4.scopeDepth === t3.scopeDepth) {
            var n3 = e4.parentScopes, r3 = t3.parentScopes, i2 = n3 === null ? 0 : n3.length, o2 = r3 === null ? 0 : r3.length;
            if (i2 === o2)
          ...
          return i2 === -1 ? (n3 = t3, r3 = "") : (n3 = t3.substring(0, i2), r3 = t3.substring(i2 + 1)), this._children.hasOwnProperty(n3) ? this._children[n3].match(r3) : e3._sortBySpecificity([].concat(this._mainRule).concat(this._rulesWithParentScopes));
        }, e3.prototype.insert = function(t3, n3, r3, i2, o2, s2) {
          if (n3 !== "") {
            var a3, c3, u3, l2 = n3.indexOf(".");
            l2 === -1 ? (a3 = n3, c3 = "") : (a3 = n3.substring(0, l2), c3 = n3.substring(l2 + 1)), this._children.hasOwnProperty(a3) ? u3 = this._children[a3] : (u3 = new e3(this._mainRule.clone(), h2.cloneArr(this._rulesWithParentScopes)), this._children[a3] = u3), u3.insert(t3 + 1, c3, r3, i2, o2, s2);
          } else
          ...
          if (t3 !== null) {
            for (var o2 = 0, s2 = this._rulesWithParentScopes.length; o2 < s2; o2++) {
              ...
              if (l(a3.parentScopes, t3) === 0)
                return void a3.acceptOverwrite(e4, n3, r3, i2);
            }
            n3 === -1 && (n3 = this._mainRule.fontStyle), r3 === 0 && (r3 = this._mainRule.foreground), i2 === 0 && (i2 = this._mainRule.background), this._rulesWithParentScopes.push(new h2(e4, t3, n3, r3, i2));
          } else
...
(function(module) {
  (function _f(self) {
    ...
    function fa(a2, b2) {
      ...
      let f = "", g = 0;
      for (let h2 = 0, k, m; h2 < d2; h2++)
        k = c2[h2], (m = a2[k]) ? (e2[g++] = F(b2 ? "(?!\\b)" + k + "(\\b|_)" : k), e2[g++] = m) : f += (f ? "|" : "") + k;
      f && (e2[g++] = F(b2 ? "(?!\\b)(" + f + ")(\\b|_)" : "(" + f + ")"), e2[g] = "");
      return e2;
    }
    function E(a2, b2) {
    ...
    function ha(a2) {
      let b2 = "", c2 = "";
      for (let d2 = 0, e2 = a2.length, f; d2 < e2; d2++)
        (f = a2[d2]) !== c2 && (b2 += c2 = f);
      return b2;
    }
    ...
    function I(a2, b2) {
      a2[b2 + "Async"] = function() {
        ...
        let f;
        D(e2) && (f = e2, delete d2[d2.length - 1]);
    ...
    function ma(a2, b2, c2, d2) {
      ...
      for (let m = e2 - 1; 0 <= m; m--) {
        const n2 = a2[m], w = n2.length, q = v();
        let r2 = !g;
        for (let l = 0; l < w; l++) {
          const p2 = n2[l], z = p2.length;
          if (z)
      ...
      if (d2)
        for (let m = d2.length - 1, n2, w; 0 <= m; m--) {
          n2 = d2[m];
          w = n2.length;
    ...
    function na(a2, b2) {
      ...
      for (let f = 0, g; f < b2.length; f++) {
        g = b2[f];
        for (let h2 = 0, k; h2 < g.length; h2++)
          k = g[h2], c2[k] && !d2[k] && (d2[k] = 1, e2[e2.length] = k);
      }
      return e2;
    }
    function J(a2) {
    ...
    t.add = function(a2, b2, c2, d2) {
      if (b2 && (a2 || a2 === 0)) {
        ...
        b2 = this.encode(b2);
        if (d2 = b2.length) {
          const m = v(), n2 = v(), w = this.depth, q = this.D;
            ...
            if (l && e2 >= this.B && (w || !n2[l])) {
              ...
              switch (this.G) {
                case "full":
                  if (3 < e2) {
                    for (f = 0; f < e2; f++)
                      for (var h2 = e2; h2 > f; h2--)
                        if (h2 - f >= this.B) {
                          var k = L(q, d2, r2, e2, f);
                          g = l.substring(f, h2);
                          M(this, n2, g, k, a2, c2);
                        }
                    break;
                ...
                case "reverse":
                  if (2 < e2) {
                    for (h2 = e2 - 1; 0 < h2; h2--)
                      g = l[h2] + g, g.length >= this.B && M(this, n2, g, L(q, d2, r2, e2, h2), a2, c2);
                    g = "";
                  }
                case "forward":
                  if (1 < e2) {
                    for (h2 = 0; h2 < e2; h2++)
                      g += l[h2], g.length >= this.B && M(this, n2, g, f, a2, c2);
                    break;
                  }
                default:
                  if (this.C && (f = Math.min(f / this.C(b2, l, r2) | 0, q - 1)), M(this, n2, l, f, a2, c2), w && 1 < d2 && r2 < d2 - 1) {
                    for (e2 = v(), g = this.A, f = l, h2 = Math.min(w + 1, d2 - r2), e2[f] = 1, k = 1; k < h2; k++)
                      if ((l = b2[this.F ? d2 - 1 - r2 - k : r2 + k]) && l.length >= this.B && !e2[l]) {
                        e2[l] = 1;
                        const p2 = this.l && l > f;
                        M(this, m, p2 ? f : l, L(g + (d2 / 2 > g ? 0 : 1), d2, r2, h2 - 1, k - 1), a2, c2, p2 ? l : f);
                      }
                  }
              }
            }
    ...
    function M(a2, b2, c2, d2, e2, f, g) {
      let h2 = g ? a2.h : a2.map;
      if (!b2[c2] || g && !b2[c2][g])
        a2.s && (h2 = h2[d2]), g ? (b2 = b2[c2] || (b2[c2] = v()), b2[g] = 1, h2 = h2[g] || (h2[g] = v())) : b2[c2] = 1, h2 = h2[c2] || (h2[c2] = []), a2.s || (h2 = h2[d2] || (h2[d2] = [])), f && h2.indexOf(e2) !== -1 || (h2[h2.length] = e2, a2.m && (a2 = a2.register[e2] || (a2.register[e2] = []), a2[a2.length] = h2));
    }
    t.search = function(a2, b2, c2) {
      ...
      for (let n2, w; c2 < e2; c2++) {
        w = a2[c2];
        h2 ? (n2 = sa(this, d2, f, b2, g, e2 === 2, w, m), f && n2 === false && d2.length || (m = w)) : n2 = sa(this, d2, f, b2, g, e2 === 1, w);
        if (n2)
          return n2;
        if (f && c2 === e2 - 1) {
          k = d2.length;
    ...
    function sa(a2, b2, c2, d2, e2, f, g, h2) {
      let k = [], m = h2 ? a2.h : a2.map;
      a2.s || (m = ua(m, g, h2, a2.l));
      if (m) {
        let n2 = 0;
        const w = Math.min(m.length, h2 ? a2.A : a2.D);
        for (let q = 0, r2 = 0, l, p2; q < w; q++)
          if (l = m[q]) {
            if (a2.s && (l = ua(l, g, h2, a2.l)), e2 && l && f && (p2 = l.length, p2 <= e2 ? (e2 -= p2, l = null) : (l = l.slice(e2), e2 = 0)), l && (k[n2++] = l, f && (r2 += l.length, r2 >= d2)))
              break;
          }
        if (n2) {
          if (f)
    ...
    t.remove = function(a2, b2) {
      ...
      if (c2) {
        ...
        if (this.cache) {
          b2 = this.cache;
          for (let d2 = 0, e2, f; d2 < b2.h.length; d2++)
            f = b2.h[d2], e2 = b2.cache[f], e2.indexOf(a2) !== -1 && (b2.h.splice(d2--, 1), delete b2.cache[f]);
        }
      }
      return this;
    };
      ...
      if (a2.constructor === Array)
        if (e2)
          ...
          for (let g = 0, h2; g < e2; g++)
            if (h2 = a2[g])
              f = N(h2, b2, c2, d2, e2), d2 || f || delete a2[g];
        }
      else
        for (let g in a2)
          (f = N(a2[g], b2, c2, d2, e2)) || delete a2[g];
      return f;
    }
    t.searchCache = oa;
    t.export = function(a2, b2, c2, d2, e2) {
      ...
      ra(a2, b2 || this, c2 ? c2 + "." + f : f, d2, e2, g);
      return true;
    };
    ...
    function Q(a2) {
      ...
      x(d2) && (d2 = [d2]);
      for (let e2 = 0, f, g; e2 < d2.length; e2++)
        f = d2[e2], x(f) || (g = f, f = f.field), g = C(g) ? Object.assign({}, a2, g) : a2, this.o && (c2[f] = new O(g), c2[f].o || (this.o = false)), this.o || (c2[f] = new K(g, this.register)), this.K[e2] = S(f, this.A), this.h[e2] = f;
      if (this.C)
    ...
    function V(a2, b2, c2, d2, e2, f, g, h2) {
      if (a2 = a2[g])
        if (d2 === b2.length - 1) {
          if (a2.constructor === Array) {
            if (c2[d2]) {
              for (b2 = 0; b2 < a2.length; b2++)
                e2.add(f, a2[b2], true, true);
              return;
            }
            a2 = a2.join(" ");
          }
          ...
          for (g = 0; g < a2.length; g++)
            V(a2, b2, c2, d2, e2, f, g, h2);
        else
          g = b2[++d2], V(a2, b2, c2, d2, e2, f, g, h2);
    }
    t = Q.prototype;
    t.add = function(a2, b2, c2) {
      ...
      if (b2 && (a2 || a2 === 0)) {
        if (!c2 && this.register[a2])
          return this.update(a2, b2);
        for (let d2 = 0, e2, f; d2 < this.h.length; d2++)
          f = this.h[d2], e2 = this.K[d2], x(e2) && (e2 = [e2]), V(b2, e2, this.A, 0, this.index[f], a2, e2[0], c2);
        if (this.I) {
          let d2 = T(b2, this.I), e2 = v();
          x(d2) && (d2 = [d2]);
          for (let f = 0, g, h2; f < d2.length; f++)
            if (g = d2[f], !e2[g] && (e2[g] = 1, h2 = this.l[g] || (this.l[g] = []), !c2 || h2.indexOf(a2) === -1)) {
        ...
        if (this.store && (!c2 || !this.store[a2])) {
          ...
          if (this.C) {
            d2 = v();
            for (let e2 = 0, f; e2 < this.C.length; e2++)
              f = this.C[e2], x(f) ? d2[f] = b2[f] : U(b2, d2, f, 0, f[0]);
          }
          this.store[a2] = d2 || b2;
        }
      }
    ...
    t.search = function(a2, b2, c2, d2) {
        ...
        if (c2.constructor === Array)
          ...
          if (m && (x(m) && (m = [m]), !a2)) {
            for (let l = 0, p2; l < m.length; l++)
              if (p2 = ya.call(this, m[l], b2, w, h2))
                e2[e2.length] = p2, q++;
            return q ? e2 : [];
          }
          x(k) && (k = [k]);
      ...
      k || (k = this.h);
      n2 = n2 && (1 < k.length || m && 1 < m.length);
      const r2 = !d2 && (this.o || this.async) && [];
      for (let l = 0, p2, z, B; l < k.length; l++) {
        let A;
        z = k[l];
        x(z) || (A = z, z = z.field);
        if (r2)
          r2[l] = this.index[z].searchAsync(a2, b2, A || c2);
        else {
          d2 ? p2 = d2[l] : p2 = this.index[z].search(a2, b2, A || c2);
          B = p2 && p2.length;
          if (m && B) {
            const y = [];
            let H = 0;
      ...
      if (r2) {
        ...
        return new Promise(function(p2) {
          Promise.all(r2).then(function(z) {
            p2(l.search(a2, b2, c2, z));
          });
        });
      }
      if (!q)
      ...
      if (g && (!h2 || !this.store))
        return e2[0];
      for (let l = 0, p2; l < f.length; l++) {
        p2 = e2[l];
        p2.length && h2 && (p2 = za.call(this, p2));
        if (g)
          return p2;
        e2[l] = { field: f[l], result: p2 };
      }
      return e2;
    };
    function ya(a2, b2, c2, d2) {
      let e2 = this.l[a2], f = e2 && e2.length - c2;
      if (f && 0 < f) {
        if (f > b2 || c2)
    ...
    t.export = function(a2, b2, c2, d2, e2) {
      ...
      if (d2 < this.h.length) {
        ...
        b2 = this;
        setTimeout(function() {
          g.export(a2, b2, e2 ? f.replace(":", "-") : "", d2, e2++) || (d2++, e2 = 1, b2.export(a2, b2, f, d2, e2));
        });
      } else {
        let f;
        switch (e2) {
